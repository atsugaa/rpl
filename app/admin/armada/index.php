<?php
    ...
    <div class="flex flex-col  sm:flex-row items-center justify-start mb-4">
        ...
        <a href="tambah.php" class="md:m-6 mr-4 inline-block px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Tambah Armada</a>
    </div>
