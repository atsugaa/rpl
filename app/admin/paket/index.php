<?php
    ...
    if (isset($_GET['pkt'])) {
        ...
        $flag = 1;
    ?>
    <a href="tambah.php" class="m-6 w-fit inline-block items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Tambah Paket Wisata</a>
    <a href="#" class="w-fit inline-block items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-600 rounded-lg hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300">Export Excel</a>
